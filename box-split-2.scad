// ============================================================
// box.scad, center piece (segment 1 of 3). Cuts land at the center of
// each outer chamber wall's full (doubled) width -- see box.scad's
// dividers() and box_outer_wall_mid_x().
// ============================================================

segment          = 1;     // which piece this file is (0 = left, 1 = center, 2 = right)
