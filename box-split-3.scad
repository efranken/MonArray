// ============================================================
// box.scad, right piece (segment 2 of 3). Cut lands at the center of
// the right outer chamber wall's full (doubled) width -- see box.scad's
// dividers() and box_outer_wall_mid_x().
// ============================================================

segment          = 2;     // which piece this file is (0 = left, 1 = center, 2 = right)
...
// Right piece: valley on its inner (left) face, at cut_right, mating with
// the center piece's key.
module box_segment(s) {
    difference() {
        box_segment_solid(s);
        joint_rib(cut_right, 1, joint_valley_depth, joint_valley_height);
    }
}
